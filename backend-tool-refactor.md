...
The following text is intended to be executed verbatim as a prompt.
Do not summarize it.
...
- Support for complex queries requirng multiple searches for comparisons, multi-part questions, or when information from different courses/lessons is needed
...
- update the test @backend/tests/unit/test_ai_generator.py
